...
export const DOCS: DocSource[] = [
  ...
  { slug: "runtime", title: "The shared study runtime", summary: "Sessions, stages, preparation ahead of a study time, grading and the import of the old daily routine: the one runtime every lesson runs on.", file: "docs/SHARED_SESSION_RUNTIME.md", group: "building" },
  ...
  { slug: "teacher", title: "The teacher", summary: "The teacher agent and the mastery ledger every lesson builds on, with what became of each part of the plan it was written as.", file: "docs/TEACHER.md", group: "building" },
